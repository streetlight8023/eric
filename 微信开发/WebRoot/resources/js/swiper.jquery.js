...
(function () {
    ...
    window.Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            // Pagination分页
            PaginationOpen: false,//打开分页自定义内容 与PaginationText配合
            PaginationText: [],//PaginationOpen为true之后添加自定义内容
            pagination: null,
            ...
            if (s.paginationContainer && s.paginationContainer.length > 0) {
                ...
                for (var i = 0; i < numberOfBullets; i++) {
                    if (s.params.paginationBulletRender) {
                    	...
                    	if(s.params.paginationOpen){
                    			bulletsHTML += '<span class="' + s.params.bulletClass + '">'+ s.params.paginationText[i] +'</span>';
                    	}else{
